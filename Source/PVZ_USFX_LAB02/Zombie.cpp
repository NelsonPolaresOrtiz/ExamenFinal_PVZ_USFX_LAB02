...
AZombie::AZombie()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh>ZombieMeshAsset(
			TEXT("StaticMesh'/Game/StarterContent/Shapes/Shape_QuadPyramid.Shape_QuadPyramid'"));


	//Mesh o aspecto alternativo
	//static ConstructorHelpers::FObjectFinder<UStaticMesh> ZombieMeshAsset2(
	//		TEXT("StaticMesh'/Game/StarterContent/Architecture/Pillar_50x500.Pillar_50x500'"));
...
void AZombie::SetZombieDirection(const FVector& NewDirection)
{

}

// Dentro de la implementación de la clase AZombie en Zombie.cpp
void AZombie::AplicarEfectoQuemar()
{
	bQuemandose = true;

	// Puedes realizar acciones adicionales relacionadas con el efecto de quemar si es necesario
}
