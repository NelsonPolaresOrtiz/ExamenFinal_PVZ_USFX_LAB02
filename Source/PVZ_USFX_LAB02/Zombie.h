...
public:
	...
	virtual void NotifyHit(class UPrimitiveComponent* MyComp, AActor* Other,
		...
		//esta funcion nos notifica cada golpe que de la clase.

	// Función para cambiar la dirección del zombie
	UFUNCTION(BlueprintCallable, Category = "Zombie")
		void SetZombieDirection(const FVector& NewDirection);
	void AplicarEfectoQuemar();
	// Dentro de la clase AZombie en Zombie.h
public:
	bool bQuemandose;
