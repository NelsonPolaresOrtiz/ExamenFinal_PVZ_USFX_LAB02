...
APlant::APlant()
{
	...
	static ConstructorHelpers::FObjectFinder<UStaticMesh> PlantaMesh(
...
//nombre de la planta
FString APlant::GetNombrePlanta()
{
	//Retorna el nombre de la planta
	return NombrePlanta;
}

bool APlant::IsActorDestroyed() const
{
